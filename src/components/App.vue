<template>
  <div class="flex min-h-screen flex-col" @click="enableSound()">
    ...
    <!-- Loading -->
		<div class="fixed inset-0 z-50 flex items-center justify-center bg-white/0"
      v-if="isLoading"
    >
      <div role="status" class="absolute -translate-x-1/2 -translate-y-1/2 top-2/4 left-1/2">
        <svg aria-hidden="true" class="w-20 h-20 text-gray-300 animate-spin dark:text-gray-300 fill-gray-100" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
